...
VALUES ('Easton', '5MM Steel X HIT™ Break-Off', 'HIT', 'hit', NULL, 75, 2.50, 0, NULL, NULL, 1, 'hit');

-- 5MM Half-Out Inserts ($27.99 / 12 = $2.33/arrow)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '5MM Half-Out 25gr Aluminum', 'half-out', 'half-out', NULL, 25, 2.33, 0, NULL, NULL, 1, 'half-out');

INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '5MM Half-Out 75gr Steel', 'half-out', 'half-out', NULL, 75, 2.33, 0, NULL, NULL, 1, 'half-out');

-- 5MM Steel Half-Outs ($24.99 / 12 = $2.08/arrow)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '5MM Steel Half-Out 50gr', 'half-out', 'half-out', NULL, 50, 2.08, 0, NULL, NULL, 1, 'half-out');

-- 5MM Match Grade Half-Outs ($31.99 / 6 = $5.33 | $36.99 / 6 = $6.17)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '5MM Match Grade Half-Out 55gr', 'half-out', 'match-grade', NULL, 55, 5.33, 0, NULL, NULL, 1, 'half-out');

INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '5MM Match Grade Half-Out 75gr', 'half-out', 'match-grade', NULL, 75, 6.17, 0, NULL, NULL, 1, 'half-out');

-- 4MM Aluminum Half-Out ($38.99 / 12 = $3.25/arrow)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Aluminum Half-Out 50gr', 'half-out', 'half-out', NULL, 50, 3.25, 0, NULL, NULL, 1, 'half-out');

-- 4MM Steel Half-Out ($34.99 / 12 = $2.92/arrow)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Steel Half-Out 95gr', 'half-out', 'half-out', NULL, 95, 2.92, 0, NULL, NULL, 1, 'half-out');

-- 4MM Titanium Half-Out ($50.99 / 6 = $8.50/arrow)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Titanium Half-Out 55gr', 'half-out', 'titanium', NULL, 55, 8.50, 0, NULL, NULL, 1, 'half-out');

-- 4MM Match Grade Half-Outs (range $31.99–$57.99 / 6 — prices estimated per weight)
INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Match Grade Half-Out 55gr', 'half-out', 'match-grade', NULL, 55, 5.33, 0, NULL, NULL, 1, 'half-out');

INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Match Grade Half-Out 75gr', 'half-out', 'match-grade', NULL, 75, 6.67, 0, NULL, NULL, 1, 'half-out');

INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Match Grade Half-Out 100gr', 'half-out', 'match-grade', NULL, 100, 8.33, 0, NULL, NULL, 1, 'half-out');

INSERT INTO inserts (brand, model, system, type, shaft_id_in, weight_grains, price_per_arrow, requires_collar, collar_weight_grains, collar_price_per_arrow, active, product_type)
VALUES ('Easton', '4MM Match Grade Half-Out 150gr', 'half-out', 'match-grade', NULL, 150, 9.67, 0, NULL, NULL, 1, 'half-out');
